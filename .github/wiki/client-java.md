...
public final class SnowflakeUtils {
    ...
    private static final RestTemplate REST_TEMPLATE = new RestTemplate(
            Collections.singletonList(new ProtobufJsonFormatHttpMessageConverter())
    );
    ...
    public static List<Long> nextIds(int n) {
        final String url = "http://<host>:<port>/id?n={n}";
        final SnowflakeProto.IdList idList = REST_TEMPLATE.getForEntity(url, SnowflakeProto.IdList.class, n).getBody();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(com.github.yingzhuo.snowflake.proto.SnowflakeProto.IdList other) {
        if (other == com.github.yingzhuo.snowflake.proto.SnowflakeProto.IdList.getDefaultInstance()) return this;
...
```java
package com.github.yingzhuo.snowflake.json;
...
public final class SnowflakeUtils {
    ...
    public static List<Long> nextIds(int n) {
        final String url = "http://<host>:<port>/id?n={n}";
        return REST_TEMPLATE.getForEntity(url, List.class, n).getBody();
    }
